	...
	if(usr)
		if (usr.client)
			if(usr.client.holder)
				to_chat(M, "<i>You hear a voice beckoning from Aetherius... <b>[msg]</i></b>")
...
client/proc/cmd_admin_daedric_message(mob/M in GLOB.mob_list)
	...
	message_admins(msg)
	admin_ticket_log(M, msg)
	SSblackbox.record_feedback("tally", "admin_verb", 1, "Daedric Message") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
